...
export const ROOMS: Room[] = [
  ...
  },
  {
    ...
    floor: "Planta principal",
    name: "Habitación",
    description: "Una cama de 2 plazas.",
    beds: [{ size: "2 plazas", count: 1 }] satisfies Bed[],
    hasBathroom: false,
    order: 1,
    createdAt: now,
  },

  // Casa Grande — 6 habitaciones (5 en la casa principal + Cabaña exclusiva 12+)
  // 1er piso
  {
  ...
  // 2do piso
  {
    ...
    description: "Dos camas de 2 plazas.",
    beds: [{ size: "2 plazas", count: 2 }] satisfies Bed[],
    hasBathroom: false,
    order: 2,
    createdAt: now,
  },
  {
    ...
    propertyId: CASA_GRANDE_ID,
    floor: "2do piso",
    name: "Dormitorio múltiple",
    description: "Tres camas de 1 plaza y media.",
    beds: [{ size: "1.5 plazas", count: 3 }] satisfies Bed[],
    hasBathroom: false,
    order: 3,
    createdAt: now,
  },
  ...
  {
    id: "bbbbbbb2-0000-0000-0000-000000000006",
    propertyId: CASA_GRANDE_ID,
    floor: "Casa Principal · Cabaña",
    name: "Cabaña",
    description:
      "Dormitorio principal con dos camas de 2 plazas y baño completo. Se habilita exclusivamente para grupos de más de 12 personas (tarifa 16).",
    beds: [{ size: "2 plazas", count: 2 }] satisfies Bed[],
    hasBathroom: true,
    order: 5,
    createdAt: now,
...
export const CONTENT: Content[] = [
  ...
  contentRow(
    ...
    null,
    "brand.value.1.body",
    "La propiedad entera, reservada para tu grupo. Naturaleza, silencio y aire limpio a 30 minutos de Trujillo.",
  ),
  ...
  contentRow("c-ch-faq-a3", CHALET_ID, "faq.a.3", "Aproximadamente 30 minutos en auto por la carretera a Simbal. Te enviamos un pin de Google Maps al confirmar."),
  ...
  contentRow("c-q-faq-a3", CASA_GRANDE_ID, "faq.a.3", "La tarifa 12 usa la casa principal (5 habitaciones). La tarifa 16, para grupos de más de 12, habilita además la Cabaña — un espacio exclusivo con dos camas de 2 plazas."),
