...
export const RULES: Rule[] = [
  ...
  rule("rule-q-07", CASA_GRANDE_ID, "Check-in/out", "Check-in desde las 14:00. Check-out hasta las 12:00.", 6),
  rule("rule-q-08", CASA_GRANDE_ID, "Check-in/out", "Modalidad full: check-in 09:00 / check-out 18:00 del día siguiente.", 7),
...
export const PRICING_MODALITIES: PricingModality[] = [
  ...
  // Casa Grande — full_package only (v1 decision, see project memory)
  {
    id: "pm-q-01",
    propertyId: CASA_GRANDE_ID,
    name: "2 días 12 personas Lun-Jue",
    kind: "full_package",
    dayMask: 30,
    capacityTier: 12,
    priceCents: 205000,
  ...
  },
  {
    id: "pm-q-02",
    propertyId: CASA_GRANDE_ID,
    name: "2 días 12 personas Vie-Sáb-Dom",
    kind: "full_package",
    dayMask: 97,
    capacityTier: 12,
    priceCents: 225000,
  ...
  },
  {
    id: "pm-q-03",
    propertyId: CASA_GRANDE_ID,
    name: "2 días 16 personas Lun-Jue",
    kind: "full_package",
    dayMask: 30,
    capacityTier: 16,
    priceCents: 225000,
  ...
  },
  {
    id: "pm-q-04",
    propertyId: CASA_GRANDE_ID,
    name: "2 días 16 personas Vie-Sáb-Dom",
    kind: "full_package",
    dayMask: 97,
    capacityTier: 16,
    priceCents: 249000,
...
export const CONTENT: Content[] = [
  ...
  contentRow("c-q-faq-q2", CASA_GRANDE_ID, "faq.q.2", "¿Puedo hacer un evento en Casa Grande?"),
  ...
  contentRow("c-q-faq-a4", CASA_GRANDE_ID, "faq.a.4", "Sí, Casa Grande es pet-friendly. Supervisa cerca del río y el jardín."),
